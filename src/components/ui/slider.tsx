...
>(({ className, ...props }, ref) => (
	...
	>
		...
		<SliderPrimitive.Thumb
			...
			className="block h-4 w-4 rounded-full border shadow transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 border-neutral-700 bg-neutral-800 focus-visible:ring-neutral-300"
		/>
	</SliderPrimitive.Root>
));
